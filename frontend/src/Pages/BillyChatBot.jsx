        ...
        <div className="flex">
          ...
          <button onClick={() => {
            if(currentInput?.length > 0) {
              handleSubmit("Act like you are Billy, my personal virtual assistant for the stock market. You give me information about any company, their history, and information about investors.",currentInput)
            }
